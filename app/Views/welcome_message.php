...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/user/login" target="">Login</a></li>
            <li class="menu-item hidden"><a
                    href="/user/register" target="">Register</a>
            </li>
        </ul>
    </div>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to Task Part 2 </h1>

        <h2> CodeIgniter Task </h2>
